...
<form method="post" name="productDelete" id="productDelete" action="{{ route('product.update', $pm->id) }}" enctype="multipart/form-data">
@csrf
@method('PATCH')
  <div class="form-group row">
    <label for="" class="col-sm-2 col-form-label">Product Name</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="productName" id="productName" placeholder="Product Name" value="{{ $pm->name }}">
    </div>
  </div>
  <div class="form-group row">
    <label for="productPrice" class="col-sm-2 col-form-label">Price</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="productPrice" id="productPrice" placeholder="Price" value="{{ $pm->price }}">
    </div>
  </div>
  <div class="form-group row">
    <label for="productUpc" class="col-sm-2 col-form-label">UPC</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="productUPC" id="productUPC" placeholder="UPC" value="{{ $pm->upc }}">
    </div>
  </div>
  <div class="form-group row">
	...
	(Image Uploaded if you don't want to update leave blank)
	<?php } ?>
